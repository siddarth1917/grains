/* Live */
export const appId = "A3C8E933-A4A6-4C42-AD8D-DC594405DF19";
...
//export const baseUrl = "https://grainsandco.sg/";
export const baseUrl = "https://grainsnew.promobuddy.asia/";
...
export const proFolderUrl =
  "https://ccpl.promobuddy.asia/media/dev_team/products/";
...
export const googleAppId =
  "962249911621-73ii9rlt6nano22da5fk1o3qqdbig9mb.apps.googleusercontent.com";

export const CountryTxt = "Singapore";
export const productNoImg = "/img/product-noimg.jpg";
export const stripeCompany = "Grains & Co";
